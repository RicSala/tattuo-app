...
export default function PrivacyPage(props) {
    return (
        <>
            ...
            <p>En este sentido, TESYS ACTIVOS DIGITALES SL conservará los datos personales una vez terminada su relación con Ud., debidamente bloqueados, durante el plazo de prescripción de las acciones que pudieran derivarse de la relación mantenida con el interesado.&nbsp;</p>
            <p>Una vez bloqueados, sus datos resultarán inaccesibles para TESYS ACTIVOS DIGITALES SL, y no serán tratados excepto para su puesta a disposición a las Administraciones públicas, Jueces y Tribunales, para la atención de las posibles responsabilidades nacidas de los tratamientos, así como para el ejercicio y defensa de reclamaciones ante la Agencia Española de Protección de Datos.</p>
            ...
            <ol>
                ...
                <li><u>Derecho de oposición</u> al tratamiento de sus datos personales, cuando la base legal que nos habilite para su tratamiento de las indicadas sea nuestro interés legítimo. TESYS ACTIVOS DIGITALES SL dejará de tratar tus datos salvo que tenga un interés legítimo o sea necesario para la defensa de reclamaciones.</li>
                ...
                <li><u>Derecho a revocar el consentimiento</u> otorgado a TESYS ACTIVOS DIGITALES SL</li>
            </ol>
            <p>Para ejercitar sus derechos, puede hacerlo de manera gratuita y en cualquier momento, contactando con nosotros en la dirección C/ Diputación nº 37 2A (local CAD), 08015, Barcelona, adjuntando copia de su DNI.&nbsp;</p>
            <p>&nbsp;</p>
            ...
            <p>.- Sede electrónica: <span>https://www.aepd.es</span></p>
            ...
            <p>TESYS ACTIVOS DIGITALES SL se reserva el derecho a modificar la presente política para adaptarla a novedades legislativas o jurisprudenciales que puedan afectar el cumplimiento de la misma.</p>
            <p>Con objeto de garantizar el cumplimiento de la normativa sobre protección de datos de carácter personal, TESYS ACTIVOS DIGITALES SL ha recibido los servicios de consultoría y asesoramiento por parte de clickDatos.</p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <p><strong><u>POLÍTICA DE COOKIES</u></strong></p>
            <p>En la web <strong>https://hanekco.com</strong> (en adelante, el Sitio Web) utilizamos cookies para facilitar la relación de los visitantes con nuestro contenido y para permitir elaborar estadísticas sobre las visitantes que recibimos.</p>
            ...
            <p>&nbsp;</p>
            <p><strong>Tipos de cookies según el plazo de tiempo que permanecen activas</strong></p>
