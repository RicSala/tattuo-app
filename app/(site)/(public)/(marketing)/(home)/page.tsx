...
const faqs = [
    {
        ...
        answer: "TATTUO es gratis para todos los usuarios. Busca tus tatuadorxs por estilo, ciudad o descúbrelos por sus tatuajes y escríbeles directamente a sus redes sociales",
    },
    {
        question: "¿Qué precio tiene un tatuaje?",
        answer: "El precio de un tatuaje depende de muchos factores, como el tamaño, el estilo, el color, etc. Escríbele al tatuador que te interesa y cuéntale tu idea, él te dirá el precio",
    },
    ...
    },
    {
        ...
        answer: "Una vez hayas contactado con el tatuador y realizado tu tatuaje, te enviaremos un email para que puedas dejar tu reseña.",
    },
];
