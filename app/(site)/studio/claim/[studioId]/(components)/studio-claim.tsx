...
export const StudioClaim = ({ form }: { form: UserFormReturnType }) => {
    ...
    const filteredOptions = async (query: string) => {
        const studios = await ApiService.getUnclaimedStudioProfiles(query);
                ...
                render={({ field }) => (
                    <FormItem>
                        ...
                        <FormDescription>
                            ...
                            , búscalo para reclamarlo antes de seguir y si no te
                            encuentras créalo!
                        </FormDescription>
                        <FormMessage />
                    </FormItem>
