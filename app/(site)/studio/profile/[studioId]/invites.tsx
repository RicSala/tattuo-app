...
const filteredArtists = async (query: string) => {
    const artists = await ApiService.getArtistsProfiles(query);
...
export function InviteForm({ studioId }: { studioId: string }) {
    ...
    const onInvite = async (data: inviteFormBody) => {
        ...
        await ApiService.sendInvite(data);
        toast({
        ...
        <>
            <Form {...invitesForm}>
                ...
                >
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormDescription>
                                    Elige entre lxs tatuadores de Tattuo, o
                                    introduce un su email si no está en la
                                    plataforma
                                    {JSON.stringify(
                                        invitesForm.formState.errors,
                                    )}
                                </FormDescription>
                                <FormMessage />
                            </FormItem>
                    ...
                    />
                    <Button
                        disabled={loadingInviteStatus === "loading"}
                        type="submit"
                    >
                        Invitar
                    </Button>
