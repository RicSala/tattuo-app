...
export default function ContactForm({}) {
  return (
    <div className="my-auto sm:p-10">
      <section className="mx-auto max-w-screen-xl overflow-hidden md:rounded-md md:border md:shadow-lg">
        <div className="grid grid-cols-4 text-gray-800 lg:grid-cols-3">
          <div className="col-span-4 bg-primary px-8 py-10 text-primary-foreground md:col-span-2 md:border-r md:px-10 md:py-12 lg:col-span-1">
            ...
            <ul>
              <li className="mb-6 flex items-start text-left">
                <svg
                  className="mr-6 shrink-0 text-2xl text-gray-500"
              ...
              <li className="mb-6 flex items-start text-left">
                <InstagramIcon className="mr-6 shrink-0 text-2xl text-gray-500" />
                <div>
                  <a
                    className="cursor-pointer font-serif text-base md:text-lg"
                    href="#"
          ...
          <div className="order-first col-span-4 max-w-screen-md px-8 py-10 md:order-last md:col-span-2 md:px-10 md:py-12">
            <h2 className="mb-8 text-2xl text-secondary-foreground">
              ¿Prefieres escribirnos desde aquí?
            </h2>
            <p className="mb-4 mt-2 font-sans text-sm tracking-normal text-secondary-foreground">
              Cuéntanos qué necesitas
            </p>
            <form action="">
              <div className="md:col-gap-4 mb-5 grid gap-2 md:grid-cols-2">
