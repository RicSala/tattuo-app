        ...
        <div className="flex flex-col items-center">
          <div className="text-center">
            <p className="text-secondary-content text-lg font-medium">
              Descubre tatuadores que inspiran
            </p>
            <h2 className="font-pj text-base-content mt-4 text-3xl font-bold sm:text-4xl xl:text-5xl">
              Los usuarios de TATTUO opinan
            </h2>
          </div>
          ...
          {/* <div className="mt-8 text-center md:order-3 md:mt-16">
            <a
              href="#"
              title=""
              className="border-neutral text-base-content border-b-2 pb-2 font-bold leading-7 transition-all duration-200 hover:border-gray-600 hover:text-gray-600 focus:outline-none focus:ring-1 focus:ring-gray-900 focus:ring-offset-2"
            >
              {" "}
