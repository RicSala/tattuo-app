...
import MultiStepButtons from "@/app/(site)/admin/profile/components/multi-step-buttons"
...
const finderFormSchema = z.object({
    ...
    images: z.string().min(2, {
        message: "Sube una imagen, nos ayudará a encontrar el mejor tatuador para el estilo que buscas",
    })
})
...
export default function Finder({
    ...
    const onSubmit = (data) => {
        ...
        toast({
            ...
            description: 'Estamos buscando los artistas que mejor se adapten a tu estilo',
            variant: 'success',
        })
                ...
                <form onSubmit={handleSubmit(onSubmit, onError)}>
                    ...
                    <div className={` ${step === 1 ? `block` : `hidden`}`}>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="">¿Cuándo tienes pensado tatuarte?</FormLabel>
                                    <FormControl>
                                        <RadioGroup
                    ...
                    <div className={` ${step === 2 ? `block` : `hidden`}`}>
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="">¿Cuál es el tamaño aproximado del tatuaje?</FormLabel>
                                    <FormControl>
                                        <RadioGroup
                                            onValueChange={field.onChange}
                                            defaultValue={field.value}
                    ...
                    <div className={` ${step === 4 ? `block` : `hidden`}`}>
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="">¿Qué colores te gustaría que tuviera?</FormLabel>
                                    <FormControl>
                                        <RadioGroup
                                            onValueChange={field.onChange}
                                            defaultValue={field.value}
