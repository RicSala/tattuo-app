 ...
 * @typedef {ExtraProps & import("@radix-ui/react-dialog").DialogRootProps} MergedDialogRootProps
 */

/**
 * and we give it to the forward ref (first is the ref, second is the type we created in the previous step)
 * @type {React.ForwardRefRenderFunction<HTMLElement, MergedDialogRootProps>}
 */
