 ...
 * @typedef {ExtraProps & import("@radix-ui/react-dialog").DialogContentProps} MergedDialogContentProps
 */


/**
 * and we give it to the forward ref (first is the ref, second is the type we created in the previous step)
 * @type {React.ForwardRefRenderFunction<HTMLElement, MergedDialogContentProps>}
 */
