...
const postsDirectory = path.join(process.cwd(), 'app/(site)/(public)/blog/blogposts'); // gets the path to the posts folder
    ...
    return Promise.all(
        posts
            ...
            .map(async (file) => {
                ...
                return { ...data, slug, body: content, headings } // returns the metadata, slug and content of the file
            })
    )
})
